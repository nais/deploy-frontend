  ...
  return (
    <div className="infoPanel">
      ...
      >
        ...
        <Normaltekst>Please refer to the <Lenke href="https://doc.nais.io/deployment" target="new">nais documentation</Lenke> for how to use the key when setting up your deployment pipeline.</Normaltekst>
      </Veilederpanel>
    </div>
  )
}
